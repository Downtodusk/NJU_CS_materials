...
def test_hub():
    ...
    # test case 4: Packets sent to oneself
    # result in nothing happening
    testpkt = new_packet(
        "20:00:00:00:00:01",
        "20:00:00:00:00:01",
    ...
    s.expect(
        ...
        ("An Ethernet frame from 20:00:00:00:00:01 to 20:00:00:00:00:01")
    )
    s.expect(
        PacketInputTimeoutEvent(1.0),
        ("The server should not do anything in response to a frame sent by itself")
    )
    return s
