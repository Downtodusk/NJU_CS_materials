...
typedef struct CodeContent_ CodeContent_t;
typedef CodeContent_t *CodeContent;
...
struct Operand_
{
    ...
    enum
    {
        ...
        REFERR,   /**< Get address of a variable */
        DEREFERR, /**< Get value from an address */
        LABEL,    /**< Label */
        FUNC      /**< Function name */
    } kind;
...
/**
 * @enum Operator
 * @brief Enumeration of genArithmetic operators.
 */
enum Operator
{
    PLUS_OP,  /**< Addition */
...
/**
 * @brief Generate genArithmetic intermediate code.
